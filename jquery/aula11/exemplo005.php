...
$("#btn1").click(function(){
//modifica uma propriedade CSS
$("#pn1").css({'background-color':'red'});
$("#pn2").css({'background-color':'blue'});
$("#pn3").css({'background-color':'green'});
$("#pn1 .painel_cabeca").css({'background-color':'yellow'});
$("#pn1 .painel_cabeca").css({'color':'black'});
//pega quem tiver classe .painel_corpo e
//for descendente de quem tiver id = pn1
$("#pn1 .painel_corpo").html('Novo texto');
 });
});
</script>
</body>
