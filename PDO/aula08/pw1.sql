...
--
-- Host: localhost
-- Generation Time: 31-Ago-2017 às 14:22
...
--
ALTER TABLE `pessoa`
  MODIFY `cdpessoa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
-- AUTO_INCREMENT for table `situacao`
--
ALTER TABLE `situacao`
  MODIFY `cdsituacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
